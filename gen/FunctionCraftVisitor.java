...
public interface FunctionCraftVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link FunctionCraftParser#startEnd}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStartEnd(FunctionCraftParser.StartEndContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link FunctionCraftParser#appendInside}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
