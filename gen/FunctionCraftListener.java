...
public interface FunctionCraftListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link FunctionCraftParser#startEnd}.
	 * @param ctx the parse tree
	 */
	void enterStartEnd(FunctionCraftParser.StartEndContext ctx);
	/**
	 * Exit a parse tree produced by {@link FunctionCraftParser#startEnd}.
	 * @param ctx the parse tree
	 */
	void exitStartEnd(FunctionCraftParser.StartEndContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link FunctionCraftParser#appendInside}.
	 * @param ctx the parse tree
	 */
	void enterAppendInside(FunctionCraftParser.AppendInsideContext ctx);
	/**
	 * Exit a parse tree produced by {@link FunctionCraftParser#appendInside}.
	 * @param ctx the parse tree
	 */
